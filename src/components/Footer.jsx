        ...
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-2">
            ...
            <div className="flex space-x-4">
              ...
              <a href="#" className="w-10 h-10 bg-primary-500 rounded-full flex items-center justify-center hover:bg-primary-600 transition-colors">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M12.017 0C5.396 0 .029 5.367.029 11.987c0 5.079 3.158 9.417 7.618 11.174-.105-.949-.199-2.403.041-3.439.219-.937 1.406-5.957 1.406-5.957s-.359-.219-.359-1.219c0-1.142.662-1.995 1.488-1.995.219 0 .401.142.401.359 0 .219-.142.537-.219.836-.142.359-.142.717.142 1.076.284.359.717.537 1.219.537.717 0 1.406-.359 1.923-.837.517-.478.837-1.076.837-1.793 0-1.495-1.076-2.571-2.571-2.571-1.813 0-2.889 1.346-2.889 2.768 0 .537.199 1.076.478 1.495-.058.284-.219.936-.258 1.076-.041.219-.142.258-.359.142-1.346-.66-2.186-2.571-2.186-4.155 0-3.367 2.449-6.455 7.067-6.455 3.708 0 6.595 2.651 6.595 6.176 0 3.684-2.32 6.655-5.541 6.655-1.076 0-2.093-.537-2.449-1.213 0 0-.537 2.093-.66 2.571-.199.759-.717 1.714-1.076 2.313C9.417 23.783 10.717 24.012 12.017 24.012c6.624 0 11.99-5.367 11.99-11.987C24.007 5.367 18.641.001 12.017.001z"/>
                </svg>
              </a>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="space-y-3">
              <div className="flex items-center space-x-3">
                ...
                <span className="text-gray-300">info@heathome.com</span>
              </div>
              <div className="flex items-center space-x-3">
                <svg className="w-5 h-5 text-primary-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
